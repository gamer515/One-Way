...
public partial class Battle3DBattleSceneBattleBoxController : MonoBehaviour
{
    ...
    public Vector3 dialogueSize = new Vector3(14f, 4f, 0f);
    public Vector3 dialoguePos = new Vector3(0f, -2.5f, 0f);
    ...
    private IEnumerator AnimateBox(Vector3 targetSize, Vector3 targetPos, float duration)
    {
        Vector3 startSize = GetCurrentSize();
    ...
    private void UpdateWalls(Vector3 size)
    {
    ...
    {
        return new Vector3(rightWall.localPosition.x * 2f, topWall.localPosition.y * 2f, 0f);
    }

   /* public void ChangeBox(Vector3 targetSize, Vector3 targetPos, float duration)
    {
        if (resizeCoroutine != null) StopCoroutine(resizeCoroutine);
    ...
    public void ChangeBox(Vector3 targetSize, Vector3 targetCenter, float duration)
    {
    ...
    public Vector3 gaugeSize = new Vector3(14f, 3f, 0f); // 게이지용 상자 크기
    public Vector3 gaugePos = new Vector3(0f, -2.5f, 0f); // 게이지용 상자 위치
